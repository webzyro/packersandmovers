                ...
                <div class="hero-content-box">
                    ...
                    <div class="hero-content">
                        ...
                        <div class="section-title">
                            <h1 class="text-anime-style-2" data-cursor="-opaque">Stress-Free <span>Moving
                                    Experience</span></h1>
                            <p class="wow fadeInUp">Professional Solutions for Stress-Free Relocation</p>
                        </div>
                        <!-- Section Title End -->
                    </div>
                    <!-- Hero Content Start -->
                    ...
                    <div class="hero-customer-box">
                        <div class="hero-customer-content wow fadeInUp">
                            <p>Experience smooth and hassle-free relocation with expert handling,
                                secure packing, and dependable delivery services.</p>
                        </div>
                            ...
                            <div class="satisfy-customer-images">
                                <div class="satisfy-customer-image">
                                    <figure class="image-anime reveal">
                                        <img src="{{ asset('assets/images/satisfy-customer-img-1.jpg') }}" alt="">
                                    </figure>
                                </div>
                                <div class="satisfy-customer-image">
                                    <figure class="image-anime reveal">
