                ...
                <div class="success-story-images">
                    ...
                    <div class="success-story-img-1">
                        <figure class="image-anime reveal">
                            <img src="{{ asset('assets/images/success-story-image-1.jpg') }}" alt="">
                        </figure>
                    </div>
                    ...
                    <div class="success-story-img-2">
                        <figure class="image-anime">
                            <img src="{{ asset('assets/images/success-story-image-2.jpg') }}" alt="">
                        </figure>
                    </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="success-story-content">
                    ...
                    <div class="section-title ">
                        ...
                        <h2 class="text-anime-style-2" data-cursor="-opaque">Transforming moves into <span>success
                                stories</span></h2>
                        <p class="wow fadeInUp" data-wow-delay="0.2s">
                            At Grand Packers and Movers, our commitment to safe and reliable
                            relocation services has earned the trust of our happy customers.
                        </p>
