        ...
        <div class="row section-row">
            <div class="col-lg-12">
                ...
                <div class="section-title section-title-center">
                    ...
                    <h2 class="text-anime-style-2" data-cursor="-opaque">Reliable moving services built <span>around
                            you</span></h2>
                </div>
                <!-- Section Title End -->
            </div>
        ...
        <div class="row">
            ...
            <div class="work-process-list">
                ...
                <div class="work-process-item wow fadeInUp">
                    <div class="icon-box">
                        <img src="{{asset('assets/images/icon-work-process-1.svg')}}" alt="icon-work-process-1">
                ...
                <div class="work-process-item wow fadeInUp" data-wow-delay="0.2s">
                    <div class="icon-box">
                        <img src="{{asset('assets/images/icon-work-process-2.svg')}}" alt="icon-work-process-2">
                        <div class="work-process-number">
                            <h3>2</h3>
                        </div>
                    </div>
                ...
                <div class="work-process-item wow fadeInUp" data-wow-delay="0.4s">
                    <div class="icon-box">
                        <img src="{{asset('assets/images/icon-work-process-3.svg')}}" alt="icon-work-process-3">
                        <div class="work-process-number">
                            <h3>3</h3>
                        </div>
                    </div>
                ...
                <div class="work-process-item wow fadeInUp" data-wow-delay="0.6s">
                    <div class="icon-box">
                        <img src="{{asset('assets/images/icon-work-process-4.svg')}}" alt="icon-work-process-4">
                        <div class="work-process-number">
                            <h3>4</h3>
                        </div>
                    </div>
